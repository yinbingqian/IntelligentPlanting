...
import com.lnpdit.woofarm.page.adapter.FarmServiceListAdapter4;
...
public class FarmServiceListActivity4 extends BaseActivity implements OnClickListener {
    ...
    private FarmServiceListAdapter4 farmListAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        setContentView(R.layout.activity_farmservicelist4);
    ...
    private void initData() {
        ...
        String[] property_va = new String[] { "3" };
           ...
           if (res.getObj() != null) {
               ...
               if (json_objs.get("result").toString().equals("true")) {
                   ...
                   if(farmList.size()!=0){
                       ...
                       farmListAdapter = new FarmServiceListAdapter4(context, farmList);
