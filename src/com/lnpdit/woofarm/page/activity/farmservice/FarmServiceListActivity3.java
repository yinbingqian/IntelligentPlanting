...
import com.lnpdit.woofarm.page.adapter.FarmServiceListAdapter3;
...
public class FarmServiceListActivity3 extends BaseActivity implements OnClickListener {
    ...
    private FarmServiceListAdapter3 farmListAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        setContentView(R.layout.activity_farmservicelist3);
    ...
    private void initData() {
        ...
        String[] property_va = new String[] { "2" };
           ...
           if (res.getObj() != null) {
               ...
               if (json_objs.get("result").toString().equals("true")) {
                   ...
                   if(farmList.size()!=0){
                       ...
                       farmListAdapter = new FarmServiceListAdapter3(context, farmList);
