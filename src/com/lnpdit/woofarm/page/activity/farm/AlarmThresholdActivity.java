...
public class AlarmThresholdActivity extends FragmentActivity implements OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alarmthreshold);
    ...
    private void initData() {
        ...
        fragmentsList.add(new AlarmDayFragment());
        fragmentsList.add(new AlarmNightFragment());

        tags = new String[] { "白天", "夜晚" };
