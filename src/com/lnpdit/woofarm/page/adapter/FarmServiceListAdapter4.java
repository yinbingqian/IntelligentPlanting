...
public class FarmServiceListAdapter4 extends BaseAdapter {
    ...
    public FarmServiceListAdapter4(Context context, List<FarmServiceVideoList> appList) {
        mAppList = appList;
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_farmservicelist4, parent,
                    false);
