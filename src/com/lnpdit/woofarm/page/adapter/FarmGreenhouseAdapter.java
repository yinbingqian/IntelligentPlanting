...
public class FarmGreenhouseAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.peng_name.setText(appInfo.getPengName());
        ...
        holder.plantdays_tv.setText(appInfo.getPlantDays());
        ...
        holder.yield_tv.setText(appInfo.getYield());
        Instance.imageLoader.displayImage(SOAP_UTILS.IP + appInfo.getImgUrl(), holder.plant_img, Instance.new_s_options);
        return convertView;
    }
