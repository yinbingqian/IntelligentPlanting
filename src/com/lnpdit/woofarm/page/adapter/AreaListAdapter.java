...
public class AreaListAdapter extends BaseAdapter {
    ...
    private Area appInfo;
    private List<Area> mAppList;
    private LayoutInflater mInflater;
    private Context mContext;
    private buttonViewHolder holder;

    public AreaListAdapter(Context context, List<Area> appList) {
        mAppList = appList;
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.content_layout = (RelativeLayout) convertView
        ...
        holder.content_layout.setBackgroundResource(value);
