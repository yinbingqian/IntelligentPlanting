 ...
 * @文件描述：环境曲线图
 **********************************************************/
class LineGraphicViewEnvironment extends View
{
    /**
     * 公共部分
     */
    ...
    public LineGraphicViewEnvironment(Context context)
    {
        this(context, null);
    }

    public LineGraphicViewEnvironment(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    {
        mPaint.setColor(res.getColor(R.color.paintcolor));
    ...
    private void drawText(String text, int x, int y, Canvas canvas)
    {
        ...
        p.setColor(res.getColor(R.color.paintcolor));
