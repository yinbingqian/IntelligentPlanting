...
public class BuyNowPopWin extends PopupWindow {
    ...
    public BuyNowPopWin(Context mContext, View.OnClickListener itemsOnClick) {

        this.view = LayoutInflater.from(mContext)
                .inflate(R.layout.activity_productconfirm, null);
